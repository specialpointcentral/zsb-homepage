...
//print $urltemp;
$p = Curl("http://zsb.hitwh.edu.cn/ajax/SearchScoreline.aspx" . $urltemp);
http_response_code($p["code"]);
echo $p["return"];

//http://zsb.hitwh.edu.cn/ajax/SearchEnrollmentPlan.aspx?year=2018&province=北京&proname=null&_=1526799670901
